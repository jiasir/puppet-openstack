...
# credentials
$admin_email             = 'jiasir@icloud.com'
$admin_password          = 'jiasir'
$cinder_user_password    = 'jiasir'
$cinder_db_password      = 'jiasir'
$keystone_db_password    = 'jiasir'
$keystone_admin_token    = 'db94d0278600dee8f879'
$nova_db_password        = 'jiasir'
$nova_user_password      = 'jiasir'
$glance_db_password      = 'jiasir'
$glance_user_password    = 'jiasir'
$rabbit_password         = 'jiasir'
$rabbit_user             = 'jiasir'
$fixed_network_range     = '10.0.0.0/24'
$floating_network_range  = '192.168.20.0/24'
$secret_key              = 'db94d0278600dee8f879'
$mysql_root_password     = 'jiasir'
